...
public class KeyManager : MonoBehaviour
{
    ...
    //Shapes
    private GameObject circleKey;
    private GameObject squareKey;
    private GameObject triangleKey;
        ...
        foreach (Transform _ts in shapesTransforms)
        {
            if (_ts != null)
            {
                if (_ts.tag == CheckForColour(_player3))
                {
                    ...
                    {
                        GameObject _gb;
                        _gb = Instantiate(squareKey, _pos, _rot, transform);
                    ...
                    {
                        GameObject _gb;
                        _gb = Instantiate(triangleKey, _pos, _rot, transform);
                        _gb.transform.localScale = _sca;
                        _gb.tag = _tag;
                    ...
                    {
                        GameObject _gb;
                        _gb = Instantiate(circleKey, _pos, _rot, transform);
                        _gb.transform.localScale = _sca;
                        _gb.tag = _tag;
