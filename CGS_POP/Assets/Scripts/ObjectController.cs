...
public class ObjectController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((P1T == true && allowGrow == true) || (global::GamePlayer.P1T && CheckColours())) {
            Player1Action();
        }

        if ((P2T == true && allowPull == true) || (global::GamePlayer.P2T && CheckColours()))
        {
            Player2Action();
        }

        if ((P3T == true && allowSwitch == true) || (global::GamePlayer.P3T && CheckColours()))
        {
            Player3Action();
        }

        if ((P4T == true) || (global::GamePlayer.P4T && CheckColours()))
        {
            Player4Action();
        }
    ...
    private bool CheckColours()
    {
        ...
        {
            case "Red":
                if (global::GamePlayer.colourRed)
                {
                    return true;
                }
                break;
            case "Yellow":
                if (global::GamePlayer.colourYellow)
                {
                    return true;
                }
                break;
            case "Green":
                if (global::GamePlayer.colourGreen)
                {
                    return true;
                }
                break;
            case "Blue":
                if (global::GamePlayer.colourBlue)
                {
                    return true;
                }
                break;
